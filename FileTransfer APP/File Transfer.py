...
def send():
    ...
    Button(window, text="+ select file", width=12, height=1, font="arial 14 bold", bg="#fff", fg="#000",
           command=select_file).place(x=150, y=150)

    selected_file_label = Label(window, text="", bg="#f4fdfe", fg="#000", font="arial 10 italic")
    selected_file_label.place(x=20, y=200)

    Button(window, text="SEND", width=10, height=1, font="arial 14 bold", bg="#fff", fg="#000", command=sender).place(
        x=310, y=150)
...
backgrouund = PhotoImage(file="fileimages/background.png")
Label(root, image=backgrouund).place(x=-2, y=323)
